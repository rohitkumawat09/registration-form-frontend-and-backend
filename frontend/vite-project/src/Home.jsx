...
Friend
  ...
  />
  <label htmlFor="terms" className="toggle-label"   
    onClick={() => setShowTerms(true)}
  ></label>
</div>

          <label htmlFor="terms" onClick={() => setShowTerms(true)} style={{ cursor: "pointer", }}>
...
>
  I Agree
        ...
        <button onClick={() => setShowTerms(false)} style={{ backgroundColor: "#6c757d", color: "#fff", border: "none", padding: "8px 12px", borderRadius: "4px" }}>Close</button>
      </div>
    </div>
  </div>
)}
